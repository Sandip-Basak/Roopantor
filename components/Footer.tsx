      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-display text-3xl text-roopantor-black mb-6">ROOPANTOR</h3>
            <p className="text-roopantor-textLight font-serif leading-relaxed max-w-md italic mb-8">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-roopantor-black mb-6">Explore</h4>
