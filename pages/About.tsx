    ...
    <PageTransition className="w-full">
      ...
      <div className="pt-32 pb-20 container mx-auto px-6 text-center">
        <motion.img 
            ...
            alt="Logo Mark" 
            className="mx-auto rounded-full w-24 h-24 mb-8 border-2 border-roopantor-gold p-1" 
        />
        <motion.h1 
        ...
        <motion.div 
            ...
            className="h-1 bg-roopantor-green mx-auto mb-12" 
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto">
            {['New Perspective', 'The Overlooked', 'Unity in Art'].map((title, i) => (
                <motion.div 
                    ...
                    className="p-8 border border-white/10 hover:border-roopantor-gold transition-colors duration-500 hover:bg-white/5"
                >
                    <h3 className="text-xl font-display text-roopantor-gold mb-4">{title}</h3>
                    <p className="font-serif text-roopantor-cream/70">
      ...
      <section className="py-20 bg-roopantor-charcoal">
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
              ...
              >
                   ...
                   <p className="font-serif text-lg text-roopantor-cream/80 mb-6 leading-relaxed">
                   ...
                   <p className="font-serif text-lg text-roopantor-cream/80 leading-relaxed">
      ...
      <section className="py-24 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {TEAM.map((member, index) => (
                ...
                >
                    <div className="relative mb-6 mx-auto w-64 h-80 overflow-hidden">
                         <div className="absolute inset-0 bg-roopantor-gold mix-blend-multiply opacity-0 group-hover:opacity-60 transition-opacity duration-500 z-10" />
                    ...
                    <p className="text-xs uppercase tracking-widest text-roopantor-gold mb-4">{member.role}</p>
                    {member.bio && (
                        <p className="text-sm font-serif text-roopantor-cream/60 max-w-xs mx-auto italic">"{member.bio}"</p>
                    )}
                </motion.div>
            ))}
        </div>
